  ...
  <div id="index">
    ...
    <div class="statusStruc">
      ...
      <div class="columnStruc">
        ...
        <Button @click="modal = true" style="margin-top:10px" type="primary" size="small">单字归零</Button>
        <Modal v-model="modal" title="警告！" @on-ok="resetOK" @on-cancel="resetCancel">
          您確定要把所有單字歸零嗎？
        </Modal>
      </div>
    </div>
